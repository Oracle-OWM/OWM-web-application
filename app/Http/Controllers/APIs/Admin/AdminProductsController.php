...
class AdminProductsController extends Controller
{
    ...
    {
        $products = Product::where('state', '=', 'approved')->get()->map(function ($product) {
            ...
            return [
                ...
                'state' =>$product->state,
                'image' =>$product->image,
                'service_provider_id' =>$product->serviceProvider->id,
                'service_provider_username' =>$product->serviceProvider->username,
                'category_id' =>$product->category->id,
                'category_name' =>$product->category->name,
                'category_image' =>$product->category->image,
                'car_model_id' =>$product->carModel->id,
                'car_model_name' =>$product->carModel->model_name,
                'car_model_manufacture' =>$product->carModel->car_manufacture,
                'car_model_year' =>$product->carModel->car_year,
                'car_model_image' =>$product->carModel->image,
            ];
            $product->category;
            $product->carModel;
        });
