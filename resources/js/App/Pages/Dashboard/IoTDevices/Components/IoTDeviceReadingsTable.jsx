                        ...
                        <tr key={index}>  
                          ...
                          <td className="py-4 pl-3 whitespace-nowrap">
                            <div className="flex flex-row items-left text-left">
                              <div className="ml-4">
                                <p className="text-sm text-gray-500">{IoTDeviceReadnig.flow_rate ? IoTDeviceReadnig.flow_rate +'%': '-'}</p>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="py-4 pl-3 whitespace-nowrap">
                            <div className="flex flex-row items-left text-left">
                              <div className="ml-4">
                                <p className="text-sm text-gray-500">{IoTDeviceReadnig.consumed_liters ? IoTDeviceReadnig.consumed_liters +' / min': '-'}</p>
                              </div>
                            </div>
                          </td>
